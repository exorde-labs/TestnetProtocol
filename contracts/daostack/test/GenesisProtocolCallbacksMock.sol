...
contract GenesisProtocolCallbacksMock is Debug, VotingMachineCallbacksInterface, ProposalExecuteInterface, Ownable {
    ...
    mapping(bytes32 => uint256) public proposalsBlockNumbers;
    ...
    function setParameters(uint256[11] calldata _params, address _voteOnBehalf) external returns (bytes32) {
