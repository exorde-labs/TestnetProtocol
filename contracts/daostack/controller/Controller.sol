...
// import "../../worksystems/StakingManager.sol";
...
contract Controller is ControllerInterface {
     ...
     * @return bool which represents a success
     */
    function upgradeStakingManager(address _stakingManager)
        external
        onlyUpgradingScheme
        returns (bool)
    {
    ...
    function isStakingManagerRegistered(address _stakingManagerAddress, address _avatar) external view isAvatarValid(_avatar) returns (bool) {
    ...
    function _isStakingManager(address _stakingManager) private view returns (bool) {
