...
contract WalletScheme is Ownable {
    ...
    function proposeCalls(
        ...
        bytes32 proposalId = abi.decode(
            votingMachine.functionCall(
                ...
                "WalletScheme: EXDVotingMachine callback propose error"
            ),
            (bytes32)
        );
    ...
    /**
     * @dev EXDVotingMachineCallbacks DONT REMOVE
     */
    ...
    function addWorksystemAddress(address _address) external onlyOwner {
    ...
    function removeWorksystemAddress(address _address) external onlyOwner {
        ...
        return
            abi.decode(
                controller.functionCall(
                    ...
                    "WalletScheme: EXDVotingMachine callback mintReputation error"
                ),
                (bool)
            );
    }
        ...
        return
            abi.decode(
                controller.functionCall(
                    ...
                    "WalletScheme: EXDVotingMachine callback burnReputation error"
                ),
                (bool)
            );
    }
        ...
        return
            abi.decode(
                controller.functionCall(
                    ...
                    "WalletScheme: EXDVotingMachine callback externalTokenTransfer error"
                ),
                (bool)
            );
    }
        ...
        return
            abi.decode(
                avatar.functionStaticCall(
                    ...
                    "WalletScheme: EXDVotingMachine callback nativeReputation error"
                ),
                (address)
            );
    }
        ...
        return
            abi.decode(
                getNativeReputation().functionStaticCall(
                    ...
                    "WalletScheme: EXDVotingMachine callback totalSupply error"
                ),
                (uint256)
            );
    }
        ...
        return
            abi.decode(
                getNativeReputation().functionStaticCall(
                    ...
                    "WalletScheme: EXDVotingMachine callback totalSupplyAt error"
                ),
                (uint256)
            );
    }
        ...
        return
            abi.decode(
                getNativeReputation().functionStaticCall(
                    ...
                    "WalletScheme: EXDVotingMachine callback balanceOfAt error"
                ),
                (uint256)
            );
    }
